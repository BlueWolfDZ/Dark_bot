...
.setThumbnail(message.author.avatarURL)    
      ...
      .addField("**rمريم **","**لـ تشغيل لعبة مريم**")
      .addField("**rخواطر **","**لـ تشغيل لعبة خواطر**")
      .addField("**rلو خيروك **","**لـ لتشغيل لعبة لو خيروك**")
      .addField("**rحكم  **","**لـ تشغيل لعبة حكم**")
      .addField("**rعقاب  **","**لـ تشغيل لعبة عقاب**")
      .addField("**rقرعه  **","**لـ تشغيل لعبة قرعه**")
      .addField("**rكت تويت **","**لـ تشغيل لعبة كت تويت**")
      .addField("**rحب **","**لـ تشغيل لعبة حب**")
      .addField("**rصراحه **","**لـ تشغيل لعبة صراحه**")
.setColor('RANDOM')
  message.author.sendEmbed(embed);
    }
});
...
.setThumbnail(message.author.avatarURL)    
      ...
      .addField("**d!play :musical_note:**","**لـ تشغيل المطلوب**")
      .addField("**d!stop  :musical_keyboard:**","**لـ ايقاف المطلوب**")
      .addField("**d!pause :musical_score:**","**لـ ايقاف المطوب مؤقت**")
      .addField("**d!resume :mute: **","**لـ تشغيل المطوب بعد التوقيف**")
.setColor('RANDOM')
  message.author.sendEmbed(embed);
    }
});
  ...
  console.log(`Logged in as ${client.user.tag}!`);
         ...
         client.on('message', message => {
            if (message.content === 'رابط') {
              message.channel.send('ضيفني في سيرفرك  :heart: https://discordapp.com/api/oauth2/authorize?client_id=458343259656159256&permissions=0&scope=bot');
